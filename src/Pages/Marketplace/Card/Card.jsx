...
const card = () => {
  ...
  return (
    <Link
      className="flex flex-col overflow-hidden h-44 bg-blue-400 rounded-xl shadow-md"
      to={link}
    >
      <div
        className={`flex-1 bg-cover bg-no-repeat bg-center bg-[image:url('${props.image}')] `}
      />
